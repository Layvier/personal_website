...
export const HeroSection: React.FC<{}> = () => {
  return (
    ...
    >
      ...
      >
        <Text color="white" as="h1" textStyle="h1">Olivier<br/>Ramier</Text>
        <VStack spacing={[4, 2]} alignItems="start" textStyle="h4">
          <Text color="white" as="h4">Consulting</Text>
          <Text color="white" as="h4">
            Building Stuff (Checkout <Link color="teal-lighter" href="#">Mapedia</Link>)
          </Text>
          <Text color="white" as="h4">Fullstack Software Development</Text>
        </VStack>
      </Section>
    </Box>
  )
