              ...
              <Stack direction={{ base: 'column', lg: 'row' }} spacing={5}>
                <Box flexGrow={1}>
                  <Text>
                    ...
                    help find our way through this ocean of information.
                  </Text>
                  <Text mt={2}>
                    With this project, my goal is to improve the way people learn online and create a new way to consume
                    knowledge by leveraging the collective intelligence.
                  </Text>
                </Box>
                  ...
                  <List spacing={3}>
                    ...
                    <ListItem display="flex" alignItems="center">
                      ...
                      <Text as="span">
                        ...
                        <Link href="http://github.com/sci-map-org/" fontWeight={600} isExternal>
                          Github
                        </Link>
                      </Text>
                    </ListItem>
              ...
              <Box minW="40%">
                <List spacing={3} fontFamily={fonts.spartan} fontWeight={500}>
                  <ListItem display="flex" alignItems="center">
                    ...
                    <Text as="span">
                      More on{' '}
                      <Link href="https://www.youtube.com/watch?v=783ZtAF4j5g" fontWeight={600} isExternal>
                  ...
                  <ListItem display="flex" alignItems="center">
                    ...
                    <Text as="span">
                      Checkout the code on{' '}
                      <Link href="https://github.com/Layvier/ant-colony-elixir" fontWeight={600} isExternal>
                        Github
                      </Link>
                    </Text>
                  </ListItem>
                  <ListItem display="flex">
                    ...
                    <Text as="span">
                      A{' '}
                      <Link href="https://poolik.github.io/visual-aco/#/visualisation" fontWeight={600} isExternal>
                        visualisation
                      </Link>{' '}
...
const Project: React.FC<{ title: React.ReactNode; content: React.ReactNode }> = ({ title, content }) => {
  return (
