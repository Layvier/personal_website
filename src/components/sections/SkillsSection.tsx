...
const skills: Skill[] = [
  ...
  },
  {
    ...
    size: 7,
    popoverContent:
      '<span class="searchmatch">Sass</span> is a preprocessor scripting language that is interpreted or compiled into Cascading Style Sheets.',
  ...
  return (
    <Popover trigger="hover">
      ...
      <PopoverContent borderWidth={2} borderColor="black" borderRadius={0}>
        ...
        <PopoverBody>
          <Text
            dangerouslySetInnerHTML={{ __html: skill.popoverContent }}
          ></Text>
          {skill.seeMoreLink && (
            <Link
              fontWeight={600}
              href={skill.seeMoreLink}
              isExternal
              float="right"
            >
